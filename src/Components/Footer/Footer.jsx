    ...
    return (
      ...
      <footer className="footer p-10 bg-base-200 text-base-content">
        <div>
            ...
            <p className='text-2xl'>Word University.<br/>Providing reliable tech since 1992</p>
            <p className='text-[15px]'>this is Word University on of the best <br></br> music school in USA</p>
        </div> 
                ...
                <div className='text-[18px]'>
                    <span className="footer-title">University Details <FaSchool></FaSchool></span> 
        ...
        <footer className="footer footer-center p-4 bg-base-300 text-base-content">
            <div>
                <p className='text-[20px]'>Copyright © 2023 - All right reserved by Word University</p>
            </div>
        </footer>
      </>
    );
